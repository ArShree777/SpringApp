 ...
 * @author aryas
 */
@Repository(value = "SkillDAOImpl")//Dependency Injection ko lagi..
public class SkillDAOImpl implements SkillDAO {
    ...
    public int insert(Skill model) {
        String sql = "insert into mst_skills(name) value('?')";
    ...
    public int update(Skill model) {
        ...
        return jdbcTemplate.update(sql, new Object[]{model.getName(), model.getId()});
    }
